...
// ============================================================ Short List
async function addToShortList(item = null) {
  const payload = item || currentResult;
  if (!payload) { alert('Please run a valuation first.'); return; }
  ...
  setStatus(`✅ ${payload.symbol || 'Stock'} added to Short List (${data.count} total)`, 'success');
